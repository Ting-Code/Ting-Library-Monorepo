...
const createPrettierLog = (): PrettierLog => {
    ...
    const createLogFunction = (defaultTitle: string, defaultColor: Color) =>
    ...
    const table = <T extends Record<string, unknown>>(data: T[], options: Partial<TableOptions> = {}) => {
...
export default createPrettierLog