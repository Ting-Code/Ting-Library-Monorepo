...
export default class World extends kokomi.Component {
  ...
  handleAssets() {
    ...
    ;(items['ut_floor_roughness'] as THREE.Texture).colorSpace = THREE.LinearSRGBColorSpace
  ...
  enter() {
    ...
    this.t2.to(this.base.params, {
      ...
      ease: 'power2.inOut',
      onUpdate: () => {
        lightColor.copy(blackColor).lerp(whiteColor, this.base.params.lightAlpha)
  ...
  async rush() {
    ...
    this.t8.to(this.base.params, {
      ...
      ease: 'power2.out',
      onUpdate: () => {
        this.speedup.material.uniforms.uOpacity.value = this.base.params.speedUpOpacity
    ...
    this.t6.fromTo(
      ...
      { floorLerpColor: 0, furinaLerpColor: 0 },
      {
        ...
        onUpdate: () => {
          ...
          furinaColor.lerp(furinaOriginalColor, this.base.params.furinaLerpColor)
          this.furina?.setColor(furinaColor)
        }
      }
    )
