    ...
    series: [
      {
        name: '出生人口',
        type: 'scatter',
        data: years.map((year, index) => [index, birthPopulation[index]])
      },
      {
        name: '大学毕业人数',
        type: 'scatter',
        data: years.map((year, index) => [index, collegeGraduates[index]])
      },
      {
        name: '本科毕业人数',
        type: 'scatter',
        data: years.map((year, index) => [index, undergraduateGraduates[index]])
      }
    ]
  }
